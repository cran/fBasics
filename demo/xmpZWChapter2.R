...
#   "Rmetrics" offers collection of functions for managing 'timeDate' 
#   and 'timeSeries' objects. These functions were designed on their 
#   own concept differing from the objects having the same names in 
#   "S-Plus". But they also allow with some "flexibility of the user" 
#   to solve the problems which are presented in the examples of 
#   Chapter 2 of the above mentioned book.
...
################################################################################
# CHAPTER 2.2 - The Specification of 'timeSeries' Objects
...
################################################################################
# CHAPTER 2.3 - TIME SERIES MANIPULATIONS 
...
# ------------------------------------------------------------------------------    
# 2.3.1 PART B: Creating Differences    
...
# ------------------------------------------------------------------------------    
# 2.3.3 PART A: Computing Asset Returns - Compute Returns
...
################################################################################
# CHAPTER 2.4 VISUALIZING TIME SERIES
...
# ------------------------------------------------------------------------------
# 2.4.1 Plotting 'timeSeries' Objects Using the Generic Plot Function
    ...
    # Just use auto-legend (from Hmisc)
    plot(singleIndex.dat, lty = c(1, 3), leg = TRUE, xlab = "Year", 
    ...
    par(mfrow = c(2, 1), cex = 0.75)
    plot(
        singleIndex.dat[, "MSFT"], 
        type = "l",
        main = "Monthly Price on Microsoft",
        col = "steelblue4")
    plot(
        singleIndex.dat[, "SP500"], 
        type = "l",
...
# ------------------------------------------------------------------------------
# 2.4.2 Trellis Plotting Functions
