...
# YC (2013-04-28): In an effor to remove built-in code from
# thrid-party packages, gss package is now imported. For the time
# being, we keep the hidden functions as wrapper to avoid
# back-compatibily.
